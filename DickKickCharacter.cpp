...
ADickKickCharacter::ADickKickCharacter(const FObjectInitializer& ObjectInitializer)
...
void ADickKickCharacter::UpdateAnimation()
{
...
void ADickKickCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
...
void ADickKickCharacter::MoveRight(float Value)
{
...
void ADickKickCharacter::TouchStopped(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	StopJumping();
}
